...
「LEDマスク、セレブがよくやってるやつ」——気になりながらも、価格を見て一度は諦めた方も多いのではないでしょうか。

私もずっとそうでした。でも今年のゴールデンウィーク、ついに試してみる決断をしました。そして使ってみると「なんでもっと早く始めなかったんだろう」と思っています。

この記事では、**CurrentBody（カレントボディ）のLEDフェイスマスク**を実際に使ってわかったこと、そして**2026年GWセール（4/25〜5/11）でお得に買う方法**をお伝えします。
...
{{< rawhtml >}}
<div class="box-point">
LEDフェイスマスクが美容界で注目される理由は「光の波長」にあります。赤色光（633nm）はコラーゲン産生を促し、近赤外線（830nm）は皮膚の深層まで届いてエネルギー代謝をサポート。痛みゼロで、医療機関でも使われるアプローチが自宅で再現できます。
</div>
{{< /rawhtml >}}
...
翌朝の肌のトーンが違う。「なんかくすみが取れた？」という感覚は、使い始めて数日目から出てきました。
...
- 朝の顔がむくみにくくなった
- 化粧のりが明らかに良くなった
- 「最近肌きれいじゃない？」と言われるようになった

「一発で劇的に変わる」ではなく、**毎日少しずつ積み上がっていく変化**という感じです。でもそれが、長く続けるモチベーションになります。
...
**医療グレードの技術**：CurrentBodyのLEDデバイスは複数の臨床試験でエビデンスが確認されています。「なんとなく光を当てる」系のデバイスとは異なります。
...
**価格が高い**：通常価格は5〜7万円台。GWセール中がもっともお得なタイミングです。
...
CurrentBodyの**ゴールデンウィークセール**は、年に数回しかない大型セールのひとつです。
...
通常価格から20%オフになるのは、LEDマスクのような高単価デバイスにとってかなり大きな差額です。

「ずっと気になっていた」という方は、**このタイミングを逃すと次のセールまで待つことになります。**

{{< rawhtml >}}
<div style="text-align:center; margin: 1.5em 0;">
  <a href="https://px.a8.net/svt/ejp?a8mat=4B1R5P+FYJBJM+54TM+5ZMCH" target="_blank" rel="nofollow noopener">
    <img border="0" width="300" height="250" alt="CurrentBody LEDマスク" src="https://www23.a8.net/svt/bgt?aid=260422333965&wid=001&eno=01&mid=s00000023953001006000&mc=1">
  </a>
  <img border="0" width="1" height="1" src="https://www15.a8.net/0.gif?a8mat=4B1R5P+FYJBJM+54TM+5ZMCH" alt="">
</div>
