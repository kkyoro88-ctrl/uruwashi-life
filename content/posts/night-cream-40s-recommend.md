...
### 3位：ORBIS オルビス ユー クリーム（化粧品）

**こんな方に向いています**：無添加・無香料派・セラミド保湿を重視する・3,000円以内のバランス重視

オルビスの人気スキンケアライン「ユー」シリーズのクリームです。セラミドを中心とした保湿成分を配合し、肌のバリア機能をサポートするとされています。無香料・無着色で、乾燥敏感肌の方にも使いやすい設計が特徴です。
...
ナイトクリームはスキンケアの最後に使います。それまでの保湿成分を閉じ込める役割（オクルージョン）があるため、他のアイテムの後に重ねるのが基本です。

### 量と塗り方

- **米粒2〜3粒分**が目安。多すぎると毛穴詰まりの原因になる場合も
- **指の腹で優しくなじませる**。ゴシゴシ塗らない
- **目の周り・口元**は特に薄い皮膚なので、優しくのせる程度に
- **塗った後すぐ枕につかない**：5分程度なじませてから就寝すると◎

---

## 比較表

| | エリクシール スーペリア | 肌ラボ 極潤プレミアム | ORBIS ユー |
|--|-------------------|------------------|----------|
| 区分 | 医薬部外品 | 化粧品 | 化粧品 |
| 価格（目安） | 約4,400円 | 約1,500円 | 約2,970円 |
| 主な成分 | ナイアシンアミド | ヒアルロン酸・コラーゲン | セラミド |
| テクスチャー | クリーム | ジェル | クリーム |
| 無香料 | × | ◯ | ◯ |
| おすすめの方 | シワ改善重視 | コスパ重視 | 無添加・敏感肌 |

---

## こんな方には、正直急かしません

- 「今のクリームで満足している」→ 無理に変える必要はない。変化を感じたときに
- 「日中クリームで十分では？」→ 日中は紫外線・乾燥のダメージを受け続ける。夜用に特化したクリームは夜のターンオーバーに合わせた設計のため、使い分けに意味があるとされています
- 「寝るときにべたつくのが嫌」→ ジェルタイプや、少量塗りで試してみてください

---

## よくある質問

**Q. ナイトクリームと日中クリームの違いは何ですか？**  
A. 日中クリームは日焼け止め成分を含む場合が多く、軽いテクスチャーで化粧下地として使いやすい設計です。ナイトクリームは就寝中の肌修復に合わせ、保湿・ハリ成分が濃厚に配合されています。レチノール・ペプチドなど光に弱い成分もナイトクリームに多く使われます。

**Q. ナイトクリームはどれくらいの量を使えばいいですか？**  
A. パール1〜2粒大が目安です。多すぎるとべたつきや毛穴詰まりの原因になります。少量を薄く均一になじませる方が浸透しやすく、朝の肌のもちもち感が続きやすいとされています。

**Q. 40代から始めるなら何を基準に選べばいいですか？**  
A. まず「シワ改善」か「保湿強化」かで絞ります。シワが主な悩みなら医薬部外品表示（ニールワン・ナイアシンアミド配合）のものを。まず続けることを優先するならプチプラ・使いやすいテクスチャーから始め、慣れたらアップグレードするのが無理のない方法です。

**Q. 乳液を使っているならナイトクリームは不要ですか？**  
A. 40代以降は乳液の油分量だけでは物足りなくなるケースが増えます。特に乾燥・ハリ不足が気になるなら、乳液の上にナイトクリームを重ねることで保湿力が一段上がります。夏は乳液のみ、冬はナイトクリームをプラスと季節で使い分けるのもおすすめです。
...
資生堂エリクシールが2025年8月にリニューアルした「リフトモイスト」シリーズ。独自の**コラジェネシス**（約14万通りの組み合わせから厳選した複合成分）を新たに配合し、コラーゲン密度へのアプローチを強化しました。
...
**成分目線で見ると：** コラジェネシスは資生堂が独自に開発した複合成分で、「コラーゲン産生を促す」というアプローチを化粧品レベルで取り入れた処方です。ドラッグストアで2,000円前後という価格でこのアプローチを試せるのは現実的な選択肢。ただし「独自成分＝検証が限られる」という側面があることも頭に入れておいてください。

| | エリクシール シュペリエル リフトナイトクリーム W |
|---|---|
| 注目成分 | コラジェネシス（独自複合成分）・ハリ弾力成分 |
| リニューアル | 2025年8月 |
| 価格 | 2,000〜2,500円前後（40g・ドラッグストア） |
...
## まとめ：ナイトクリームは「寝ている間のスキンケア投資」

夜の肌はターンオーバーが活発になる時間帯。ナイトクリームはその時間を活かすためのアイテムです。

| 選ぶ理由 | おすすめ |
|---------|---------|
| シワ改善・医薬部外品を試したい | エリクシール スーペリア エンリッチドリンクルクリームT |
| まずプチプラから始めたい | 肌ラボ 極潤プレミアム ハリ浸透クリーム |
| 無添加・セラミド保湿を重視したい | ORBIS ユー クリーム |

正解かどうかはまだわからないけれど、夜のスキンケアに「ナイトクリーム」を加えてから、翌朝の肌の乾燥具合が変わった気がしています。まずは1本、試してみてください。
